...
namespace webapi.Migrations.Data
{
    ...
    [Migration("20240330173957_FriendInvites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.Models.Record", b =>
                {
                    ...
                    b.Property<long>("SelectedObjectId")
                        .HasColumnType("bigint");

                    b.Property<int>("SelectedYear")
                        .HasColumnType("int");

                    b.Property<bool>("ShowGroupList")
                        .HasColumnType("bit");

                    b.Property<bool>("YourSelf")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("webapi.Models.FriendInvites", b =>
                {
                    b.HasOne("webapi.Models.UserInfo", "SenderId")
                        .WithMany("SenderUsers")
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("webapi.Models.UserInfo", "TargetId")
